...
(function($) {
	...
	$document.ready(function () {
		rtPetslist.functions.scrollToTop();
        rtPetslist.functions.counterUp();
        rtPetslist.functions.mobileMenuDropdown();
        rtPetslist.functions.rtTabs();
        rtPetslist.functions.mobileToggleMenu();
        rtPetslist.functions.searchOverlay();
        rtPetslist.functions.mouseParallax();
        rtPetslist.functions.niceSelect();
        rtPetslist.functions.elementsCarousel();
        rtPetslist.functions.activeMenu();
        rtPetslist.functions.isotope();
	...
	$window.on('load', function() {
        rtPetslist.functions.preLoaderInit();
		rtPetslist.functions.bodyClass();
	});
